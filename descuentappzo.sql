...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-01-2019 a las 08:33:06
...
(35, 'Rollos al 2 x 1', 1, 33),
(36, 'Rollos al 2 x 1', 3, 33),
(37, 'Hamburguesas al 50% de descuento', 3, 34),
(38, 'Cortes con 40% de descuento', 1, 35),
(39, 'Tacos con 50% de descuento', 2, 36),
(40, 'Todas las alitas que puedas comer por $99', 4, 37),
(41, 'Costillas al 50% de descuento', 5, 38),
(42, 'Copeo al 5 x 1, 4 x 1 y 3 x 1', 6, 39),
(43, 'Parrilladas con 30% de descuento', 7, 40),
(44, 'Copeo al 3 x 1', 8, 41),
(45, 'Mixología a tu mesa 2 x 1', 8, 42),
(46, 'Plato fuerte + Bebida + Postre a $125', 1, 43),
(47, 'Plato fuerte + Bebida + Postre a $125', 2, 43),
(48, 'Plato fuerte + Bebida + Postre a $125', 3, 43),
(49, 'Plato fuerte + Bebida + Postre a $125', 4, 43),
(50, 'Plato fuerte + Bebida + Postre a $125', 5, 43),
(51, 'Cerveza al 50% de descuento', 1, 44),
(52, 'Cerveza al 50% de descuento', 4, 44),
(53, 'Alitas 30 x 20', 3, 45),
(54, 'Tarro de cerveza a $48', 6, 46),
(55, 'Rollos al 2 x 1', 2, 47),
(56, 'Rollos al 2 x 1', 1, 48),
(57, 'Copeo nacional al 2 x 1', 5, 49),
(58, 'Bebidas al 2 x 1 para mujeres ', 4, 50),
(59, 'Hamburguesas con papas a $69', 2, 51),
(60, 'Tarro de cerveza a $19', 3, 53),
(61, 'Rollos al 2 x 1', 2, 54),
(62, 'Platillos calientes al 2 x 1', 3, 55),
(63, '7 tacos de pibil por $30', 2, 56),
(64, '4 Tacos al Pastor x $35, 8 Tacos x $65', 2, 57),
(65, '4 Tacos al Pastor x $35, 8 Tacos x $65', 4, 57),
(66, 'Tacos al pastor al 2 x 1', 3, 58),
(67, 'Tacos orientales al 2 x 1', 8, 59),
(68, 'Tacos al pastor al 2 x 1', 2, 60),
(69, 'Tacos al carbón a 3 x 2', 2, 61),
(70, 'Hamburguesas al 3 x 2', 4, 62),
(71, 'Hamburguesas 2 x $85', 2, 63),
(72, 'Jochos 2 x $75', 4, 64),
(73, 'Alitas a $4.00 c/u', 5, 65),
(74, 'Tacos de pastor 2 x 1 en local 3 x 2 domicilo', 3, 66),
(75, 'Tacos de carnitas 2 x 1 local 3 x 2 domicilio', 1, 67),
(76, 'Pastas al 2 x 1 (Sucursal Nuevo Veracruz)', 3, 69),
(77, '2 buffets más jarra de clericot por $498', 3, 70),
(78, 'Buffet de espadas al 2 x 1', 2, 71),
(79, 'Tacos al pastor al 2 x 1', 3, 72),
(80, 'Hamburguesas al 2 x 1', 3, 73),
(81, 'Caguamas ilimitadas: M - $100, H - $200', 4, 74),
(82, 'Ceviche y 2 cervezas por $110', 8, 76),
(83, 'Micheladas 2 por $100', 8, 77),
(84, 'Palomitas de camarón + 4 cervezas de 1/4 $150', 8, 78),
(85, '10 medias XX lager por $200', 8, 79),
(86, 'Pizzas desde $89', 3, 80),
(87, 'Margaritas Frida y Jarritos Diego 2 x 1', 4, 81),
(88, 'Margaritas Frida y Jarritos Diego 2 x 1', 5, 81),
(89, '10 cuartitos por $100, Botellas al 50%', 4, 82),
(90, 'Coctelería y copeo al 2 x 1', 4, 83),
(91, '10 cuartitos por $150, Botellas al 50%', 5, 84),
(92, 'Botellas 2 x 1. Coctelería 2 x 1. Copeo 2 x 1', 6, 85),
(93, '30 alitas por $199, jarra de cerveza gratis', 4, 86),
(94, '10 alitas + 1 lt de Heineken por $99', 7, 87),
(95, 'Por cada 4 chicas 1 botella gratis', 3, 88),
(96, 'Promoción en botellas. Cuartitos a $9.00', 7, 89),
(97, 'Para ellas, cerveza de barril gratis', 2, 90),
(98, 'Tritón de 5 litros a $200', 7, 91),
(99, 'Pizzas 2 desde $149', 2, 92),
(100, 'Pizza grande + Jarra de clericot a $149', 2, 93),
(101, 'Hamburguesas 2 x $130. Hot Dog 2 x $50', 2, 94),
(102, 'Alitas $5.00 c/u. Tacos al pastor 2 x  1', 1, 95),
(103, 'Medias a $12.00. Mojitos y Caipirinhas 2x $40', 1, 96),
(104, 'Cortes a $100. Litros estándar a $60', 5, 97),
(105, 'Flautas al 2 x 1. Medias a $12', 4, 98);
...
--
ALTER TABLE `images`
  MODIFY `id_i` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;

--
-- AUTO_INCREMENT de la tabla `negocio`
--
ALTER TABLE `negocio`
  MODIFY `id_n` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
